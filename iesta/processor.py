...
class Process():
    ...
    def get_votes_w_effect(self):
        ...
        if os.path.isfile(properties.FLAT_VOTES_W_EFFECT_FILE):
            vote_w_effect_df = pd.read_parquet(properties.FLAT_VOTES_W_EFFECT_FILE)
        else:
    ...
    def get_ideology_based_voter_participant_df(self, ideology):
        ...
        if os.path.isfile(file_path):
            ...
            not_found_args_df = pd.read_parquet(properties.MISSING_ARGS_FILE.format(ideology.lower()))
        else:
